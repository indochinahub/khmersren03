...
class Deck extends MyController
{
    ...
    public function addEdit($task, $id = "0")
    {
        ...
        $data["deck_command1_col"] = "";
        $data["deck_command2_col"] = "";
        $data["deck_command3_col"] = "";
        $data["deck_command4_col"] = "";

        $data["deck_answer1_col"] = "";
        $data["deck_answer2_col"] = "";
        $data["deck_answer3_col"] = "";

        $data["deck_choice1a_col"] = "";
        $data["deck_choice1b_col"] = "";
        $data["deck_choice1c_col"] = "";
        $data["deck_choice1d_col"] = "";

        $data["deck_choice2a_col"] = "";
        $data["deck_choice2b_col"] = "";
        $data["deck_choice2c_col"] = "";
        $data["deck_choice2d_col"] = "";

        $data["deck_choice3a_col"] = "";
        $data["deck_choice3b_col"] = "";
        $data["deck_choice3c_col"] = "";
        $data["deck_choice3d_col"] = "";

        $data["deck_choice4a_col"] = "";
        $data["deck_choice4b_col"] = "";
        $data["deck_choice4c_col"] = "";
        $data["deck_choice4d_col"] = "";
